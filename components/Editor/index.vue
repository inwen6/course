  ...
  methods: {
    init() {
      ...
      this.Quill.on("editor-change", (eventName, ...args) => {
       ...
       this.Quill.getModule("toolbar").addHandler("image", this.uploadImageHandler) //自定义图片上传
    },
    uploadImageHandler () {
    ...
    async uploadImage(event){
      ...
      let {url} = await aloss("qingting_fu_wen_ben/", `${file.uid}.${file.type.split("/")[1]}`, file);
